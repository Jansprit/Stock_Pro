    ...
    <div ref={containerRef} className="relative w-full max-w-md">
      <div className="relative">
        ...
        <input
          ...
          className="
            w-full rounded-lg border border-slate-700 bg-slate-900/70
            py-2.5 pl-10 pr-10 text-sm text-slate-100 placeholder:text-slate-500
      ...
      {open && results.length > 0 && (
        <div
          className="
            ...
            rounded-lg border border-slate-700 bg-slate-900 shadow-2xl shadow-slate-950/40
            animate-fade-in
          "
        >
          {results.map((r, idx) => (
            <button
              ...
              className={`
                ...
                transition-colors
                ${activeIndex === idx ? 'bg-slate-800' : 'hover:bg-slate-800/50'}
              `}
            >
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-0.5 truncate text-xs text-slate-400">{r.name}</div>
              </div>
